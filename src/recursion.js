...
var arraySum = function(array) {
  ...
  //  return that first element plus the sum of all subsequent elements
  // if the first element is an array:
  //  return the sum of that first element plus the sum of all subsequent elements
...
var palindrome = function(string) {
  ...
  // if the length is one, return true
  // if the first and last chars aren't the same, return false
  //   else if the length is 2, return true
  //   else if the length is > 2, return palindrome(the string, less its first and last chars) 
  if (string.length === 1) {
    return true;
  }
...
var rMap = function(array, callback) {
  ...
  return array.length === 1 ? [callback(array[0])]
...
var countValuesInObj = function(obj, value) {
  ...
  for (k in obj) {
    ...
    if (typeof obj[k] === 'object' && !Array.isArray(obj[k])) {
      res += countValuesInObj(obj[k], value);
    }
  }
  return res;
};
